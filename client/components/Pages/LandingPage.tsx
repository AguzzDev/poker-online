      ...
      <section className="h-screen screenWidth mt-10 pb-5">
        ...
        >
          ...
          <div className="hidden sm:flex flex-1">
            <div className="relative w-full h-full scale-125 1920:scale-150 translate-y-8 md:translate-y-14 lg:translate-y-16 xl:translate-y-20 -translate-x-5 sm:-translate-x-0 md:-translate-x-14 lg:-translate-x-16 xl:-translate-x-20">
              <Image
