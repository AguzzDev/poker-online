...
export class GameService {
  ...
  async shuffle(roomId: string, cards: CardInterface[]) {
  ...
  async playersRebuyChips({ roomId, server, players }) {
  ...
  async initialRound({ roomId, room, server, playerPos }) {
  ...
  async advancedRound({ roomId, type, server }) {
